...
const Country = () => {
  ...
  const country = countriesData.countries.find(c => c.name.toLowerCase() === countryName.toLowerCase());
  ...
  return (
    <div className="association-page">
      ...
      <p>Discover the different structures working to promote tennis in {country.name}.</p>
